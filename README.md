...
<p align="center">
  ...
  <a href="https://sourcegraph.com/github.com/cpdevs/webrtc?badge"><img src="https://sourcegraph.com/github.com/cpdevs/webrtc/-/badge.svg" alt="Sourcegraph Widget"></a>
  ...
  <br>
  <a href="https://travis-ci.org/cpdevs/webrtc"><img src="https://travis-ci.org/cpdevs/webrtc.svg?branch=master" alt="Build Status"></a>
  <a href="https://pkg.go.dev/github.com/cpdevs/webrtc/v3"><img src="https://pkg.go.dev/badge/github.com/cpdevs/webrtc/v3" alt="PkgGoDev"></a>
  <a href="https://codecov.io/gh/cpdevs/webrtc"><img src="https://codecov.io/gh/cpdevs/webrtc/branch/master/graph/badge.svg" alt="Coverage Status"></a>
  <a href="https://goreportcard.com/report/github.com/cpdevs/webrtc"><img src="https://goreportcard.com/badge/github.com/cpdevs/webrtc" alt="Go Report Card"></a>
...
**[GoDoc](https://pkg.go.dev/github.com/cpdevs/webrtc/v3)** is an auto generated API reference. All our Public APIs are commented.

**[FAQ](https://github.com/cpdevs/webrtc/wiki/FAQ)** has answers to common questions. If you have a question not covered please ask in [Slack](https://pion.ly/slack) we are always looking to expand it.
...
Join our [Office Hours](https://github.com/cpdevs/webrtc/wiki/OfficeHours). Come hang out, ask questions, get help debugging and
...
* [SettingEngine](https://pkg.go.dev/github.com/cpdevs/webrtc/v3#SettingEngine) for Pion specific extensions
...
* [Simulcast](https://github.com/cpdevs/webrtc/tree/master/examples/simulcast)
...
* Wide platform support
  ...
  * iOS, Android
  * [WASM](https://github.com/cpdevs/webrtc/wiki/WebAssembly-Development-and-Testing) see [examples](examples/README.md#webassembly)
...
### Roadmap
The library is in active development, please refer to the [roadmap](https://github.com/cpdevs/webrtc/issues/9) to track our major milestones.
We also maintain a list of [Big Ideas](https://github.com/cpdevs/webrtc/wiki/Big-Ideas) these are things we want to build but don't have a clear plan or the resources yet.
...
### Contributing
Check out the **[contributing wiki](https://github.com/cpdevs/webrtc/wiki/Contributing)** to join the group of amazing people making this project possible:
