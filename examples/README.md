...
1. Build and run the example server:
    ``` sh
    GO111MODULE=on go get github.com/cpdevs/webrtc/v3
    git clone https://github.com/cpdevs/webrtc.git $GOPATH/src/github.com/cpdevs/webrtc
    cd $GOPATH/src/github.com/cpdevs/webrtc/examples
    go run examples.go
    ```
